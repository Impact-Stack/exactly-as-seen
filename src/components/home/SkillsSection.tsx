      ...
      <div className="container-narrow">
        <div className="text-center mb-12">
          ...
          <motion.p
            ...
            className="text-lg text-[#9CA3AF] max-w-3xl mx-auto"
          >
            Core competencies across software engineering, cloud delivery,
            security, and project execution.
          </motion.p>
        </div>
        ...
        <div className="mt-10 glass p-6 md:p-8">
          ...
          <p className="text-[#9CA3AF] leading-relaxed">
            DevOps and CI/CD delivery pipelines, algorithmic problem solving,
            and practical cybersecurity labs. The focus is to improve delivery
            speed, resilience, and enterprise security posture across real-world
            projects.
          </p>
        </div>
      </div>
