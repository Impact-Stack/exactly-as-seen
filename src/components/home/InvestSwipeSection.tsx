...
export default function InvestSwipeSection() {
  ...
  return (
    <section className="section-padding bg-secondary border-y border-white/[0.08] overflow-hidden" ref={ref}>
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.5 }}>
            ...
            <h2 className="text-section font-display mb-2 heading-gradient">InvestSwipe</h2>
            ...
            <ul className="space-y-3 mb-8">
              {["Accessible entry point for all investors", "Short-form education content", "Simple swipe interaction model", "Community learning features"].map((f) => (
            ...
            <Link to="/investswipe" className="inline-block bg-primary text-primary-foreground px-8 py-4 rounded-lg text-body font-semibold hover:bg-primary-dark transition-colors btn-primary-glow">
              Join Waitlist
            </Link>
          </motion.div>
