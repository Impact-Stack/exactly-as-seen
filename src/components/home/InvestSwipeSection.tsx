...
export default function InvestSwipeSection() {
  ...
  return (
    <section className="section-padding bg-card border-y border-border overflow-hidden" ref={ref}>
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <span className="inline-block bg-success/10 text-success text-label px-3 py-1.5 rounded-lg mb-6 border border-success/20">
              COMING Q3 2026
            </span>
            <h2 className="text-section font-display mb-2">InvestSwipe</h2>
            <p className="text-card-title text-muted-foreground font-light mb-6">
            ...
            <ul className="space-y-3 mb-8">
              {["R10 minimum investment", "60-second education videos", "Tinder-style swipe interface", "Social trading features"].map((f) => (
                <li key={f} className="flex items-center gap-3 text-body text-foreground/70">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-primary/10 blur-[80px] rounded-full animate-glow" />
              <img
