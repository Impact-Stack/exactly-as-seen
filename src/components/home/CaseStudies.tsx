    ...
    <section className="section-padding bg-background" ref={ref}>
      <div className="container-narrow">
          ...
          {cases.map((c, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link to="/portfolio" className="text-primary text-sm font-semibold mt-3 inline-block hover:underline">
                  Read case study -&gt;
                </Link>
              </div>
            </motion.article>
        ...
        <div className="text-center">
          <Link
            to="/portfolio"
            className="inline-block border border-border bg-card text-foreground px-8 py-4 rounded-lg text-body font-semibold hover:bg-secondary transition-colors"
          >
            View All Work
          </Link>
        </div>
