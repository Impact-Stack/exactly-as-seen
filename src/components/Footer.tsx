...
export default function Footer() {
  return (
    <footer className="bg-footer text-footer-foreground border-t border-white/[0.08]">
      <div className="container-narrow section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="text-small text-muted-foreground mb-4">Trusted technology delivery partner for enterprise and public sector organizations across South Africa.</p>
          ...
          <div>
            <h4 className="tag-label text-primary mb-4">SOLUTIONS</h4>
          ...
          <div>
            <h4 className="tag-label text-primary mb-4">COMPANY</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="tag-label text-primary mb-4">CONTACT</h4>
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li><a href="mailto:hello@impactstack.africa" className="hover:text-foreground transition-colors inline-flex items-center gap-2"><Mail className="w-4 h-4" />hello@impactstack.africa</a></li>
              <li><a href="tel:+27838947546" className="hover:text-foreground transition-colors inline-flex items-center gap-2"><Phone className="w-4 h-4" />+27 83 894 7546</a></li>
      ...
      <div className="border-t border-white/[0.08]">
        <div className="container-narrow py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-small text-muted-foreground/60">
          <p>(c) 2026 ImpactStack Africa (Pty) Ltd. All rights reserved.</p>
          <div className="flex gap-4">
