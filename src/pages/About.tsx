...
const values = [
  ...
  { icon: "03", title: "Continuous Learning", desc: "R5,000 annual training budget per employee. Invest in people." },
      ...
      <PageShell>
        <section className="bg-gradient-to-br from-blue-950 to-[#0A0A0A] py-24 px-4">
          <div className="container-narrow text-center">
            ...
            <p className="text-card-title text-slate-400 font-light">Youth-led technology company creating opportunities through innovation</p>
          </div>
        </section>

        <section className="section-padding bg-[#0A0A0A]">
          <div className="container-narrow max-w-[800px] mx-auto">
            <p className="tag-label text-green-400 mb-3">OUR STORY</p>
            <h2 className="text-section text-white mb-6">From Frustration to Innovation</h2>
            <div className="space-y-4 text-body text-slate-400 leading-relaxed">
        ...
        <section className="section-padding bg-[#0D0D0D]">
          <div className="container-narrow">
            ...
            <div className="glass p-10">
              ...
              <p className="text-lg text-slate-400 mb-4">Founder and Lead Developer</p>
              <p className="text-body text-slate-400 mb-6 max-w-[700px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-small text-slate-500">JavaScript, Python, PHP, React, Vue.js, Node.js, Express, Django, Flutter, MySQL, PostgreSQL, MongoDB, AWS, and Google Cloud.</p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">Certifications</h4>
                  <ul className="text-small text-slate-500 space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map((v) => (
                <div key={v.title} className="glass p-8 card-hover">
                  ...
                  <p className="text-body text-slate-400">{v.desc}</p>
                </div>
              ))}
            </div>
          </div>
