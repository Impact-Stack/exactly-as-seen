...
const faqs = [
  ...
  {
    q: "Are there fees?",
    a: "R49/month subscription for premium (ad-free, analytics). Free tier available. Small transaction fee (R2-5 per trade).",
  },
  {
    q: "Can I lose money?",
      ...
      <PageShell>
        <section className="bg-gradient-to-br from-primary-dark to-primary py-24 px-4">
          <div className="container-narrow text-center">
            ...
            <p className="text-card-title text-primary-foreground/80 font-light mb-8">
              Making wealth creation accessible to 18 million young South Africans
            </p>
            <Link
              to="/contact"
        ...
        <section className="section-padding bg-background">
          <div className="container-narrow text-center">
            ...
            <h2 className="text-section mb-12">Why 18 Million Young South Africans Do Not Invest</h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={f} className="flex items-start gap-3 text-body">
                    <span className="text-success font-bold mt-0.5">v</span> {f}
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section className="bg-gradient-to-br from-primary-dark to-primary py-24 px-4 text-center">
          ...
          <p className="text-subtitle text-primary-foreground/80 font-normal mb-8">
