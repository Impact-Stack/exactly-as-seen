...
import { Button, Card, CardContent, Chip, Typography, Divider } from "@mui/material";
      ...
      <PageShell>
        <div className="relative min-h-screen bg-[#020205] overflow-hidden">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none">
             ...
             <div className="absolute top-[40%] right-[35%] w-1 h-1 bg-white/20 rounded-full animate-dot-float" style={{ animationDelay: '2s' }} />
             <div className="absolute bottom-[20%] left-[15%] w-1.5 h-1.5 bg-white/10 rounded-full animate-dot-float" style={{ animationDelay: '6s' }} />
             <div className="absolute bottom-[15%] right-[40%] w-1 h-1 bg-white/20 rounded-full animate-dot-float" style={{ animationDelay: '0.5s' }} />
             <div className="absolute top-[80%] left-[50%] w-1 h-1 bg-white/10 rounded-full animate-dot-float" style={{ animationDelay: '7s' }} />
          ...
          <div className="relative z-10 px-4 py-20 md:py-32">
            ...
            <header className="w-full max-w-[1600px] mx-auto text-center mb-16 md:mb-24">
              <div className="inline-block px-4 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-2xl mb-8">
                <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-blue-400">Standardized Tiers</span>
              </div>
              <h1 className="text-5xl md:text-7xl font-black text-white mb-6 tracking-tighter leading-none">
                Transparent <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500">Pricing</span>
              </h1>
              <p className="text-lg text-white/40 max-w-3xl mx-auto font-medium leading-relaxed">
                Empowering Cape Town's enterprise and public sectors with predictable delivery. 
                All project benchmarks reflect an 8-developer direct cost structure.
              </p>
            </header>
                  ...
                  <div key={offer.id} className="relative group">
                    ...
                    <Card className="relative h-full !bg-white/[0.03] !backdrop-blur-[100px] !rounded-[36px] !border !border-white/10 !text-white overflow-hidden shadow-2xl transition-all duration-500 group-hover:!border-white/20 group-hover:-translate-y-2">
                      <CardContent className="p-7 xl:p-9 flex flex-col h-full">
                        <div className="mb-8">
                          <h2 className="text-2xl font-bold mb-3 tracking-tight">{offer.title}</h2>
                        ...
                        <div className="mb-8 pt-6 border-t border-white/5">
                          <div className="flex items-baseline gap-2">
                            <span className="text-4xl font-black tracking-tight">{formatZar(offer.startingPrice)}</span>
                          </div>
                          <p className="text-[9px] text-white/20 mt-2 uppercase tracking-[0.2em] font-bold">Starting Price • Excl. VAT</p>
                        </div>

                        <div className="space-y-4 mb-10 flex-grow">
                          {offer.deliverables.map((item) => (
                            <div key={item} className="flex items-start gap-3 text-[13px] text-white/50 font-medium">
                              <span className="mt-1 flex-shrink-0 w-3.5 h-3.5 rounded-full border border-white/20 flex items-center justify-center text-[7px] bg-white/5 text-blue-400">✓</span>
                              {item}
                            </div>
                          ))}
                        </div>
                        ...
                        <Button 
                          ...
                          fullWidth className="!border-white/20 !text-white !py-4 !rounded-full !normal-case !font-bold !text-sm border !backdrop-blur-md"
                        >
                          View Tiers
                        </Button>
                      </CardContent>
                ...
                <div className="relative group">
                  ...
                  <Card className="relative h-full !bg-white/[0.05] !backdrop-blur-[100px] !rounded-[36px] !border !border-white/20 !text-white overflow-hidden shadow-2xl transition-all duration-500 group-hover:-translate-y-2">
                    <CardContent className="p-7 xl:p-9 flex flex-col h-full bg-gradient-to-br from-indigo-500/5 to-transparent">
                      <div className="mb-8">
                        <Chip label="Bulk Only" className="!bg-blue-600 !text-[9px] !font-bold !text-white !mb-4 !h-6" />
                        <h2 className="text-2xl font-bold mb-3 tracking-tight">Hardware & Gov</h2>
                        <p className="text-xs text-white/30 leading-relaxed font-medium">
                          Device reselling and infrastructure for large-scale government contracts.
                        </p>
                      </div>

                      <div className="mb-8 pt-6 border-t border-white/10">
                        <span className="text-xl font-bold tracking-tight text-white/80">Bulk Discounting</span>
                        <p className="text-[9px] text-white/20 mt-2 uppercase tracking-[0.2em] font-bold">RFP / Tender Support</p>
                      </div>

                      <div className="space-y-4 mb-10 flex-grow">
                        <div className="flex items-start gap-3 text-[13px] text-white/50 font-medium">✓ Tiered bulk pricing models</div>
                        <div className="flex items-start gap-3 text-[13px] text-white/50 font-medium">✓ Secure device logistics</div>
                        <div className="flex items-start gap-3 text-[13px] text-white/50 font-medium">✓ Maintenance & support</div>
                      </div>

                      <Button component={Link} to="/contact" fullWidth className="!border-white/20 !text-white !py-4 !rounded-full !normal-case !font-bold !text-sm border !backdrop-blur-md">
                        Request Quote
                      </Button>
                    </CardContent>
                  </Card>
            ...
            <section className="w-full max-w-[1600px] mx-auto">
              <div className="rounded-[50px] border border-white/5 bg-white/[0.01] backdrop-blur-[120px] p-10 md:p-20 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-4xl font-bold text-white mb-12 tracking-tight">Engagement Terms & Policies</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div>
                      <Typography className="!text-blue-400 !font-bold !text-xs !uppercase !tracking-widest !mb-4">Payment Structure</Typography>
                      <Typography className="!text-white !text-xl !font-bold !mb-4">50/50 Deposit Terms</Typography>
                      <Typography className="!text-white/40 !leading-relaxed text-sm">
                        A 50% deposit is required before work commences. The remaining 50% is due on the final day of delivery. 
                      </Typography>
                    </div>

                    <div>
                      <Typography className="!text-blue-400 !font-bold !text-xs !uppercase !tracking-widest !mb-4">Validity & Invoicing</Typography>
                      <Typography className="!text-white !text-xl !font-bold !mb-4">7-Day Quote Window</Typography>
                      <Typography className="!text-white/40 !leading-relaxed text-sm">
                        All quotes are valid for 7 calendar days from the date of issue. An official invoice is issued for every transaction.
                      </Typography>
                    </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex flex-wrap gap-3">
                      {customQuoteServiceNames.map((service) => (
                        <Chip key={service} label={service} className="!bg-white/5 !text-white/30 !border-white/10 !text-[11px] !font-bold !rounded-full" variant="outlined" />
                      ))}
                    </div>
